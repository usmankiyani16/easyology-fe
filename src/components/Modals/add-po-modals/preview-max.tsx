  ...
  return (
    <div className="_modal_wrap">
      ...
      >
        ...
        <Payment setImportModalOpen={setImportModalOpen} dataSource1={dataSource1} totalPrice={totalPrice} vendorId={vendorId} setPreviewMaxModalOpen={setPreviewMaxModalOpen} />
