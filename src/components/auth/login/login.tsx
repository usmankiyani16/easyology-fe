  ...
  return (
    ...
    <>
      <div className="_main-container">
        <div className="_top-container grid grid-cols-2">
          ...
          <div className="_easyology_slogan">
            ...
            <div className="_easyology_slogan_details ml-5">
              ...
              <img src={easyology_logo} alt="Shopping Easyology Logo" className='mt-5' />
        ...
        <p className="_enter_credentials text-center ">Enter your email and password below</p>
          ...
          <div className="_easyology_welcome_slogan flex mt-12 justify-around">
            ...
            <div className="_welcome_header">
              ...
              <p>Boost your business with ease and efficiency. From inventory management to analytics, we've got you covered. Let's start selling and tracking your success together</p>
