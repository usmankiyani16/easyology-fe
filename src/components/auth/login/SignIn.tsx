...
import Login_Icon from "../../../assets/images/login/login-icon.png";
import Shop from "../../../assets/images/login/login-icon.png";
import Purchase_online from "../../../assets/images/login/login-icon.png";
      ...
      <div className="signIn-container">
        ...
        <div className="Login_Details">
          <div className="container_details_Login">
            <p className="welcome_msg">Welome Back!</p>
